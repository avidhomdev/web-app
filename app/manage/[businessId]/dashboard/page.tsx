            ...
            <div className="grid rounded-xl bg-white p-2 dark:bg-gray-900 lg:grid-cols-2">
              ...
              >
                ...
                <div className="grid h-40">
                  <LineChart
                    ...
                    data={[
                      { units: 1000, date: "2024-02-02" },
                      { units: 2000, date: "2024-02-03" },
                      { units: 3000, date: "2024-02-04" },
                      { units: 1000, date: "2024-02-05" },
                      { units: 1500, date: "2024-02-06" },
                      { units: 6230, date: "2024-02-07" },
                      { units: 4500, date: "2024-02-08" },
                      { units: 10500, date: "2024-02-09" },
                    ]}
              ...
              <div className="grid items-center gap-4 p-4 lg:gap-6 lg:p-6 xl:gap-8">
                ...
                <div className="grid gap-2">
                  ...
                  <Progress progress={(100 / 100000) * 100} color="yellow" />
                </div>
                <div className="grid gap-2">
                  <div className="flex items-center justify-between gap-2">
                    <div className="text-sm font-semibold uppercase">
                  ...
                  <Progress progress={(50000 / 100000) * 100} color="cyan" />
                </div>
                <div className="grid gap-2">
                  <div className="flex items-center justify-between gap-2">
                    <div className="text-sm font-semibold uppercase">
                  ...
                  <Progress progress={(1150 / 100000) * 100} color="green" />
                </div>
              </div>
            </div>
